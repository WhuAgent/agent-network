...
class ScoreAgent(BaseAgent):
    def __init__(self, logger, name, title, task, role, description, history_number):
        ...
        super().__init__(logger, name, title, task, role, description, history_number, None, None, 0)
